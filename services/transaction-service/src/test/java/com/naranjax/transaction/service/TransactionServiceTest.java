...
class TransactionServiceTest {
        ...
        void processTransfer_Successful_WithCacheHit() {
                ...
                UserDto sender = UserDto.builder().id(senderId).firstName("Juan").lastName("Perez")
                                .email("juan@test.com")
                                .build();
                UserDto receiver = UserDto.builder().id(receiverId).firstName("Maria").lastName("Gomez")
                ...
                ArgumentCaptor<TransactionCompletedEvent> eventCaptor = ArgumentCaptor
                                .forClass(TransactionCompletedEvent.class);
        ...
        void processTransfer_Successful_WithCacheMiss() {
                ...
                Transaction transaction = Transaction.builder().id(101L).senderId(senderId).receiverId(receiverId)
                                .amount(amount)
